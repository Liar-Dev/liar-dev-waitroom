...
public class DoProcessStartAndEndGameController {
    ...
    public ResponseEntity doPreProcessBeforeGameStart(@Valid @RequestBody CommonWaitRoomRequest saveRequest) {
    ...
    public ResponseEntity doPostProcessAfterGameEnd(@Valid @RequestBody PostProcessEndGameRequest updateRequest) {
