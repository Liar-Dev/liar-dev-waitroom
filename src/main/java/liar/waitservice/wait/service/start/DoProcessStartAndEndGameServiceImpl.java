...
public class DoProcessStartAndEndGameServiceImpl implements DoProcessStartAndEndGameService<CommonWaitRoomRequest, PostProcessEndGameRequest<String>> {
     ...
     */
    private boolean deleteWaitRoomBySuccessGameEndMsg(PostProcessEndGameRequest<String> message) {
        try{
