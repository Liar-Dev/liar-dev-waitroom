...
class DoProcessStartAndEndGameRestDocsControllerDocsTest extends CommonRestDocsController {
    ...
    public void doPreProcessBeforeGameStartDocs() throws Exception {
        //given
        pushData();
        CommonWaitRoomRequest request = new CommonWaitRoomRequest(hostId, waitRoom.getId());
...
//given
        ...
        PostProcessEndGameRequest endGameDto = new PostProcessEndGameRequest(waitRoom.getId());
    ...
    private void pushData() {
        waitRoom = WaitRoom.of(new CreateWaitRoomRequest(hostId, "koseGame", 7), "gosekose");
