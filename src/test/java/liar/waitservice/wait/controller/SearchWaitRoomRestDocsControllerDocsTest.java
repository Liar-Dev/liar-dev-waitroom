...
class SearchWaitRoomRestDocsControllerDocsTest extends CommonRestDocsController {
    ...
    public void searchByRoomName() throws Exception {
        ...
        SearchWaitRoomRequest searchWaitRoomRequest = new SearchWaitRoomRequest("koseRoomName", SearchType.WAITROOMNAME.getTypeName());
        ...
        ResultActions result = mockMvc.perform(
                get("/wait-service/waitroom/search")
                        ...
                        .content(new Gson().toJson(searchWaitRoomRequest))
    ...
    public void searchBySliceRoomName() throws Exception {
        ...
        SearchWaitRoomRequest searchWaitRoomRequest = new SearchWaitRoomSliceRequest("koseRoomName", SearchType.WAITROOMNAME.getTypeName(), 0, 10);
