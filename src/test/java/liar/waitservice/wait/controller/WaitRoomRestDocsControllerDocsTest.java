...
class WaitRoomRestDocsControllerDocsTest extends CommonRestDocsController {
    ...
    public void saveWaitRoomByHost() throws Exception {
        //given
        CreateWaitRoomRequest CreateRequest = new CreateWaitRoomRequest(hostId, "game", 7);
    ...
    public void deleteWaitRoomByHost() throws Exception {
        //given
        WaitRoom waitRoom = WaitRoom.of(new CreateWaitRoomRequest(hostId, "game", 7), "roomName");
        waitRoomRedisRepository.save(waitRoom);

        CommonWaitRoomRequest DeleteRequest = new CommonWaitRoomRequest(hostId, waitRoom.getId());
    ...
    public void joinMembers() throws Exception {
        ...
        CommonWaitRoomRequest joinRequest = new CommonWaitRoomRequest(devUser1Id, waitRoom.getId());
    ...
    public void leaveMember() throws Exception {
        ...
        WaitRoom waitRoom = WaitRoom.of(new CreateWaitRoomRequest(hostId, "game", 7), "roomName");
        waitRoomRedisRepository.save(waitRoom);
        joinMemberRedisRepository.save(waitRoom.createJoinMember()); // 호스트 정보 저장
        ...
        CommonWaitRoomRequest leaveRequest = new CommonWaitRoomRequest(devUser1Id, waitRoom.getId());
