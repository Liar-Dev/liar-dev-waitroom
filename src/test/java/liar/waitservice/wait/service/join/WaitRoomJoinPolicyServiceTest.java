...
class WaitRoomJoinPolicyServiceTest extends MemberDummyInfo {
    ...
    @BeforeEach
    public void init() {
        savedWaitRoom = WaitRoom.of(new CreateWaitRoomRequest(hostId, "game", 7), hostName);
        waitRoomRedisRepository.save(savedWaitRoom);
        joinMemberRedisRepository.save(savedWaitRoom.createJoinMember());
    }
    ...
    public void createWaitRoomPolicy_createOneWaitRoomByHost() throws Exception {
        //given
        WaitRoom waitRoom = WaitRoom.of(new CreateWaitRoomRequest(hostId, "game2", 7), hostName);
    ...
    public void joinWaitRoomPolicy_joinOneWaitRoomToUser() throws Exception {
        ...
        WaitRoom waitRoom2 = WaitRoom.of(new CreateWaitRoomRequest("kose1", "game2", 7), "kose");
        waitRoomRedisRepository.save(waitRoom2); // waitRoom2 redis 저장
        joinMemberRedisRepository.save(waitRoom2.createJoinMember()); // waitRoom2의 호스트 joinMemberRedis 저장
    ...
    public void joinWaitRoomPolicy_joinOneWaitRoomToHost() throws Exception {
        ...
        joinMemberRedisRepository.save(waitRoom2.createJoinMember());
